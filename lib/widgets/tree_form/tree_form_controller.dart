 ...
 Future<bool> searchTreeById(String id) async {
   try {
     ...
     if (localTree != null) {
       ...
       print('ID cây tìm được: ${localTree.id}');
       print('ID loại cây: ${localTree.masterTreeId}');
       
       isEditing = true;
       editingId = idNumber; // ID người dùng nhập
     ...
     if (onlineTree != null) {
       ...
       print('ID: ${onlineTree.id}');
       print('Master Tree ID: ${onlineTree.masterTreeId}');
 ...
 Future<bool> handleSubmit() async {
   ...
   try {
     final details = TreeDetails(
       id: editingId, // Sử dụng đúng ID cây đang sửa
     ...
     print('ID cây: ${details.id}');
     print('ID loại cây: ${details.masterTreeId}');
